...
int main() {
    ...
    /*DIABASMA APO TO ARXEIO EISODOY(*infile), EPEKSERGASIA KAI GRAPSIMMO STO ARXEIO EKSODOY(*outfile).*/
...
/*SYNARTHSH: DIABASMA APO TO ARXEIO EISODOY(*infile), EPEKSERGASIA KAI GRAPSIMMO STO ARXEIO EKSODOY(*outfile).*/
void readWriteFile(FILE *infile, FILE *outfile)
{
    int ch;
